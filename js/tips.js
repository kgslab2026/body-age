const TIPS = {
    ...
    neural: [
        ...
        '☕ 과도한 카페인은 불안·손 떨림을 유발해 정밀한 반응을 방해할 수 있어요',
    ],
    balance: [
    ...
    vision: [
        '🥬 루테인이 풍부한 시금치·케일·브로콜리를 자주 드세요. 황반 보호에 도움됩니다',
    ...
    memory: [
        ...
        '🍇 레스베라트롤(적포도·땅콩)과 블루베리 안토시아닌은 뇌세포 보호에 도움됩니다',
        '✍️ 디지털 기기 대신 손으로 쓰기 — 기억 고정 효과가 더 뛰어납니다',
    ],
    number: [
        '🔢 숫자 암산·스도쿠·퍼즐 등 정보 처리가 필요한 두뇌 활동을 매일 하세요',
        '😴 수면 부족은 정보 처리 속도를 최대 40% 저하시킵니다. 7–9시간을 확보하세요',
        '🏃 유산소 운동은 전두엽 혈류를 늘려 실행 기능과 처리 속도를 향상시킵니다',
        '📵 멀티태스킹을 줄이세요. 한 번에 하나의 작업에 집중하면 처리 효율이 올라갑니다',
        '🫐 항산화 식품(블루베리·녹차·다크초콜릿)은 신경 신호 전달 속도 유지에 도움됩니다',
    ],
};
